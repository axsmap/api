...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    console.log(`Event ${eventId} failed to be found at edit-event`);
    return next(err);
  }
  ...
  if (data.name) {
    ...
    if (eventName !== event.name) {
      ...
      try {
        ...
        console.log(`Event ${eventName} failed to be found at edit-event`);
        return next(err);
      }
  ...
  if (data.participants) {
    ...
    try {
      ...
      console.log('Participants failed to be found at edit-event');
      return next(err);
    }
    ...
    try {
      ...
      console.log('Participants failed to be updated at edit-event');
      return next(err);
    }
  ...
  if (
    ...
    try {
      ...
      console.log(`Poster ${data.poster} failed to be found at edit-event`);
      return next(err);
    }
  ...
  if (data.teamManager) {
    ...
    try {
      ...
      console.log(`Team ${data.teamManager} failed to be found at edit-event`);
      return next(err);
    }
    ...
    try {
      ...
      console.log(`Team ${team.id} failed to be updated at edit-event`);
      return next(err);
    }
    ...
    try {
      ...
      console.log(`Team ${event.teamManager} failed to be found at edit-event`);
      return next(err);
    }
  ...
  if (data.teams) {
    ...
    try {
      ...
      console.log('Teams failed to be found at edit-event');
      return next(err);
    }
    ...
    try {
      ...
      console.log('Teams failed to be updated at edit-event');
      return next(err);
    }
  ...
  try {
    ...
    console.log(`Event ${event.id} failed to be updated at edit-event`);
    return next(err);
  }
